defmodule BayAreaBites.SchemaTest do
  ...
  describe "food_truck_food_items" do
    ...
    test "create_food_truck_food_item/1 with valid data creates a food_truck_food_item" do
      ...
      assert {:ok, %FoodTruckFoodItem{} = food_truck_food_item} = Schema.create_food_truck_food_item(valid_attrs)
    ...
    test "update_food_truck_food_item/2 with valid data updates the food_truck_food_item" do
      ...
      assert {:ok, %FoodTruckFoodItem{} = food_truck_food_item} = Schema.update_food_truck_food_item(food_truck_food_item, update_attrs)
    ...
    test "update_food_truck_food_item/2 with invalid data returns error changeset" do
      food_truck_food_item = food_truck_food_item_fixture()
      assert {:error, %Ecto.Changeset{}} = Schema.update_food_truck_food_item(food_truck_food_item, @invalid_attrs)
    ...
    test "delete_food_truck_food_item/1 deletes the food_truck_food_item" do
      food_truck_food_item = food_truck_food_item_fixture()
      assert {:ok, %FoodTruckFoodItem{}} = Schema.delete_food_truck_food_item(food_truck_food_item)
      assert_raise Ecto.NoResultsError, fn -> Schema.get_food_truck_food_item!(food_truck_food_item.id) end
    end
